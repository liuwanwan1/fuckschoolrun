...
class SharedSimulationConfigModel(Base):
    ...
    altitude_base_meters: Mapped[float] = mapped_column(Float(asdecimal=False), nullable=False, default=55.0)
    ...
    uploader_tester: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    uploader_root_device: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    root_config_included: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    root_feature_config_json: Mapped[str] = mapped_column(Text, nullable=False, default="")
    root_diagnostic_settings_json: Mapped[str] = mapped_column(Text, nullable=False, default="")
