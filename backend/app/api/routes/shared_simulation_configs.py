...
def create_config(
    ...
    author_name = "" if account is None else account.username
    return SharedSimulationConfigEnvelope(data=SharedSimulationConfigService(db).create_config(payload, author_name))
